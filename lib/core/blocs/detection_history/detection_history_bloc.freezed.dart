...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( int? idUser)?  fetch,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Fetch() when fetch != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( int? idUser)  fetch,}) {final _that = this;
switch (_that) {
case _Fetch():
return fetch(_that.idUser);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( int? idUser)?  fetch,}) {final _that = this;
switch (_that) {
case _Fetch() when fetch != null:
return fetch(_that.idUser);case _:
  return null;
