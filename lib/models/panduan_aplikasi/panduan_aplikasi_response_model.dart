...
import 'package:eder_app/models/pagination/pagination_model.dart';
...
@freezed
abstract class PanduanAplikasiResponseModel
    with _$PanduanAplikasiResponseModel {
  ...
  factory PanduanAplikasiResponseModel.fromJson(Map<String, dynamic> json) =>
